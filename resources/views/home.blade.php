<x-layouts.app>
    <div class="top-home bg-cover bg-top bg-no-repeat justify-center flex flex-wrap content-end bg-primary">
        ...
        <div class="w-full ">
            <div class="text-center container flex flex-col md:flex-row justify-center items-center mx-auto">
                <button class="btn-box "><h3>Help for Grantees </h3>
                    <p class="font-normal hidden lg:block">Are you a CCRP Grantee in need of Research support? Click
                        here!</p></button>
                <button class="btn-box "><h3>Capacity Building </h3>
                    <p class="font-normal hidden lg:block">See our growing collection of online resources.</p></button>
                <button class="btn-box "><h3>Whats On </h3>
                    <p class="font-normal hidden lg:block">We run a series of training courses and webinars throughout
                        the year.</p></button>
            </div>
        </div>
    </div>
    <div class="container mx-auto mt-5 ">
        ...
        <div class="w-5/6 mx-auto">
            <p> The Research Methods Support team (RMS) has been working with the <a href="https://www.ccrp.org/"
                                                                                     target="_blank">Collaborative Crop
